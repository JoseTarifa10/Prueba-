...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2025 a las 17:18:08
...
CREATE DATABASE IF NOT EXISTS `mi_aplicacion_web` 
DEFAULT CHARACTER SET utf8mb4 
COLLATE utf8mb4_general_ci;

-- Usar la base de datos
USE `mi_aplicacion_web`;
...
--
ALTER TABLE `herramientas`
  ADD CONSTRAINT `herramientas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`);
